...
run('member array no-init', 'struct', { 'std::array<f32, 3> arr;' }, { 'arr: [3]f32 no_init;' })
-- uninitialized members get a red no_init marker (vs `x{}` -> clean `x: T`)
run('member value no-init', 'struct', { 'GLFWbool x;' }, { 'x: bool no_init;' })
run('member value default-init', 'struct', { 'GLFWbool x{};' }, { 'x: bool;' })
run('member int no-init', 'struct', { 'int count;' }, { 'count: int no_init;' })
